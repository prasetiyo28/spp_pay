  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        ...
        <a href="{{route('export.tagihan')}}" class="pull-left mb-5 btn btn-secondary btn-sm bg-green"><i class="fa fa-download" aria-hidden="true"></i> Export</a>
    ...
    <div class="box">
      ...
      <!-- /.box-header -->
      <div class="box-body">
        <table id="tagihan-laporan" class="table table-bordered table-striped" style="width:100%!important">
           <thead>
            <tr>
              <th width="10"></th>
              <th>Nama</th>
...
<script type="text/javascript"> 
  ...
  <script type="text/javascript"> 
    $(function() {
      $('#tagihan-laporan').DataTable({
        responsive: true,
        processing: true,
        serverSide: true,
        ajax: '{!! route('tagihan.getdata.laporan') !!}',
        columns: [
