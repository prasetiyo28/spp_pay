...
<div class="box box-info">
  <div class="box-header with-border">
    <h3 class="box-title">Wali Kelas Baru</h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
  @if ($errors->any())
  ...
  @endif
  <form autocomplete="off" method="post" action="{{route('wali-kelas.store')}}">
    @csrf
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="nama" placeholder="Nama Wali Kelas">
      </div>
      <div class="form-group">
        <label>Email</label>
        <input type="email" class="form-control" name="email" placeholder="Email Wali Kelas">
      </div>
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
